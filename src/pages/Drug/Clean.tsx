...
const DrugClean: React.FC = () => {
  const columns = [
    ...
    { colKey: 'originalName', title: '原始药品名称', width: 200 },
  ...
  const data = [
    { id: 1, originalName: '阿莫西林胶囊', suggestedName: '阿莫西林', status: '待处理' },
    { id: 2, originalName: '布洛芬缓释胶囊', suggestedName: '布洛芬', status: '待处理' },
  ];

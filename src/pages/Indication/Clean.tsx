...
const IndicationClean: React.FC = () => {
  const columns = [
    ...
    { colKey: 'originalName', title: '原始适应症名称', width: 200 },
  ...
  const data = [
    { id: 1, originalName: '非小细胞肺癌(NSCLC)', suggestedName: '非小细胞肺癌', status: '待处理' },
    { id: 2, originalName: 'II型糖尿病', suggestedName: '2型糖尿病', status: '待处理' },
  ];

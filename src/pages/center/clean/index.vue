...
const tableConfig = ref<{
  ...
  columns: [
    ...
    { id: 'hosOriginName', label: '中心名称（原名称）', minWidth: 280, align: 'left' },
    { id: 'cnt', label: '相关备案/登记号', minWidth: 150, align: 'center' },
    { id: 'cleanStatus', label: '清洗状态', minWidth: 130, align: 'center' },
    { id: 'hosStandardName', label: '清洗后', minWidth: 250, align: 'left' },
    { id: 'updater', label: '操作人', minWidth: 100, align: 'center' },
    {
      id: 'updateTime',
      label: '更新时间',
      minWidth: 180,
